...
const renderStatsCard = (stats = {}, options = {}) => {
    ...
    <svg width="495" height="195" viewBox="0 0 495 195" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <rect x="0.5" y="0.5" width="494" height="194" rx="4.5" fill="${t.bg}" stroke="${hide_border === 'true' ? 'none' : '#e4e2e2'}" stroke-opacity="${hide_border === 'true' ? '0' : '1'}"/>
      ...
      <g transform="translate(25, 60)">
        ...
        <text x="25" y="12.5" class="stat">Total Stars:</text>
        <text x="150" y="12.5" class="stat">${totalStars}</text>
      </g>
      ...
      <!-- Commits -->
       <g transform="translate(25, 90)">
        ...
        <text x="150" y="12.5" class="stat">${totalCommits}</text>
      </g>
      ...
      <g transform="translate(25, 120)">
        ...
        <text x="150" y="12.5" class="stat">${totalPRs}</text>
      </g>

      <!-- Issues -->
      <g transform="translate(25, 150)">
        <path class="icon" d="M8 9.5a1.5 1.5 0 100-3 1.5 1.5 0 000 3zm0 0v-3m0 3v3m0-3h3m-3 0H5m3 7a7 7 0 110-14 7 7 0 010 14z"/>
        <text x="25" y="12.5" class="stat">Total Issues:</text>
        <text x="150" y="12.5" class="stat">${totalIssues}</text>
      </g>
